...
const Contact = ({
  resetInput, sendStatus, onSubmit, close,
}) => (
  <div>
    ...
    <div className="form">
      ...
      <ul className="actions">
        <li><input type="submit" value="Enviar Mensagem" className="special" onClick={onSubmit} /></li>
        <li><input type="reset" value="Limpar" onClick={resetInput} /></li>
        <li><h3 style={{ marginTop: '10px' }}>{sendStatus}</h3></li>
      </ul>
    </div>
    <ul className="icons">
